...
# Скрипт удаления модуля мониторинга RAID
# Путь: modules/raid/uninstall.sh
# ==============================================================================
...
readonly MODULE_NAME="raid"
readonly LOG_COMPONENT="RAID"
...
#
#    raid_alert      — признак активного алерта RAID;
#    raid.state      — состояние уведомлений (notify);
#    raid_check.lock — файл блокировки.
#

deploy_remove_file "${STATE_DIR}/raid_alert"
...
# 7. Финальный лог
#
log_success "${LOG_COMPONENT}" "Модуль мониторинга RAID успешно удалён."
