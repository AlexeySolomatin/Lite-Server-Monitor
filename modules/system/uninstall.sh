...
# Скрипт удаления модуля мониторинга системных ресурсов
# Путь: modules/system/uninstall.sh
# ==============================================================================
...
#
#    system.status      — локальный отчет о состоянии;
#    system.state       — состояние уведомлений (notify);
#    system_check.lock  — файл блокировки.
#

deploy_remove_file "${STATE_DIR}/${MODULE_NAME}.status"
...
# 7. Финальный лог
#
log_success "${LOG_COMPONENT}" "Модуль мониторинга системных ресурсов успешно удалён."
