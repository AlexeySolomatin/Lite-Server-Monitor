...
# -----------------------------------------------------------------------------
# 1. Запуск интерактивного мастера (Wizard)
# -----------------------------------------------------------------------------
# Запускается только если не передан флаг тихой установки (--quiet / --non-interactive)
if [[ "${1:-}" != "--quiet" && "${1:-}" != "--non-interactive" ]]; then
...
# -----------------------------------------------------------------------------
# 2. Логгирование и вывод баннера
# -----------------------------------------------------------------------------
ui_banner
...
# -----------------------------------------------------------------------------
# 3. Последовательный запуск шагов установки
# -----------------------------------------------------------------------------
STEPS=(
    "01_environment.sh"
    "02_packages.sh"
