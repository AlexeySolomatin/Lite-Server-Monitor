...
#
# Назначение:
#   Вспомогательные функции для интерактивного мастера установки.
#   Реализует:
...
#   При отсутствии TTY цвета автоматически отключаются (через ui.sh)
#
# ShellCheck:
#   Проходит проверку shellcheck без ошибок и предупреждений
#
