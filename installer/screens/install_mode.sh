...
# Путь: installer/screens/install_mode.sh
#
# Назначение:
#   Отображает пользователю выбор режима установки:
#
#   standard - стандартная установка:
#              устанавливаются все доступные модули,
#              создаются все базовые конфигурации,
#              пользователь настраивает только уведомления.
#
#   custom   - пользовательская установка:
#              выбор модулей и дополнительных параметров.
# -----------------------------------------------------------------------------
...
#
# standard - рекомендуемый вариант
#
...
screen_install_mode()
{
    ...
    echo "     Дополнительная настройка UPS и ежедневных отчетов."
    echo
